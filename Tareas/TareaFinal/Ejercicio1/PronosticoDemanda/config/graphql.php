...
return [
    ...
    'schemas' => [
        'default' => [
            'query' => [
                'pronosticos' => \App\GraphQL\Queries\PronosticosQuery::class,
                // ExampleQuery::class,
            ],
            'mutation' => [
                'createPronostico' => \App\GraphQL\Mutations\CreatePronosticoMutation::class,
                'updatePronostico' => \App\GraphQL\Mutations\UpdatePronosticoMutation::class,
                // ExampleMutation::class,
            ],
            // The types only available in this schema
            'types' => [
                // ExampleType::class,
                'Pronostico' => \App\GraphQL\Types\PronosticoType::class,
            ],
